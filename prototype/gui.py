...
class SearchGUI:
    ...
    def setup_data_tab(self):
        ...
        self.data_tree = ttk.Treeview(display_frame, columns=data_columns, show='headings', height=15)
        ...
        # Scrollbar for data
        data_scrollbar = ttk.Scrollbar(display_frame, orient='vertical', command=self.data_tree.yview)
