...
class SearchComparison:
    ...
    def compare_single_query(self, query: str, products: List[Dict[str, Any]], 
        ...
        for algo_name, algorithm in self.algorithms.items():
            ...
            results['algorithms'][algo_name] = {
                ...
                'stats': algorithm.get_search_stats(query, products) if hasattr(algorithm, 'get_search_stats') else {}
            }
    ...
    def print_comparison_report(self):
        ...
        print("-" * 60)
        print(f"{'Algorithm':<20} {'MAP':<8} {'MRR':<8} {'F1@5':<8} {'NDCG@10':<10} {'Avg Time(s)':<12}")
        print("-" * 60)
        ...
        for k in k_values:
            print(f"\nAt K={k}:")
            print(f"{'Algorithm':<20} {'Precision':<10} {'Recall':<10} {'F1-Score':<10} {'NDCG':<10}")
            print("-" * 60)
...
def demo_comparison():
    ...
    # Run comparison
    results = comparison.compare_multiple_queries(test_queries, sample_products)
