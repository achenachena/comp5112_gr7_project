...
This project implements a comprehensive framework for comparing search
algorithms (Keyword Matching vs TF-IDF) using real e-commerce data. The system
provides both theoretical foundations and practical implementations for
evaluating search algorithm effectiveness at scale.
...
After cloning, run `python scripts/utilities/database_initializer.py` to
