...
The web application provides a modern, browser-based interface for the E-commerce Search Algorithm Comparison project. It's built with Flask and provides a clean, academic interface for algorithm testing and comparison.
...
- ✅ **No Installation Issues**: Just run `python src/ecommerce_search/web/app.py`
...
pkill -f "python src/ecommerce_search/web/app.py"
